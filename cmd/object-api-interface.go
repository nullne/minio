...
type ObjectLayer interface {
	...
	HealObject(ctx context.Context, bucket, object string, dryRun, remove bool, scanMode madmin.HealScanMode, disksIndex map[int][]int) (madmin.HealResultItem, error)
