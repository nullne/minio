...
func (h *healSequence) healMinioSysMeta(metaPrefix string) func() error {
	return func() error {
		...
		return objectAPI.HealObjects(h.ctx, minioMetaBucket, metaPrefix, func(bucket string, object string) error {
			...
			res, herr := objectAPI.HealObject(h.ctx, bucket, object, h.settings.DryRun, h.settings.Remove, h.settings.ScanMode, h.settings.DisksIndex)
...
func (h *healSequence) healObject(bucket, object string) error {
	...
	hri, err := objectAPI.HealObject(h.ctx, bucket, object, h.settings.DryRun, h.settings.Remove, h.settings.ScanMode, h.settings.DisksIndex)
